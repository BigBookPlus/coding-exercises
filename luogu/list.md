...
本文件改编自 [SFOI-Team/luogu-problem-list](https://github.com/SFOI-Team/luogu-problem-list) 的 `list.md`（[博客原文](https://studyingfather.com/archives/841)，[洛谷题单](https://www.luogu.com.cn/training/9391)）。

改编内容：将题目条目改为 checkbox，便于在本仓库勾选进度。专题结构、题目与链接保持上游原文。

原项目采用 [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/deed.zh) 以及 [The Star And Thank Author License](https://github.com/zTrix/sata-license)。本改编同样以 CC BY-SA 4.0 共享。请为上游仓库 [点赞（Star）](https://github.com/SFOI-Team/luogu-problem-list)。
